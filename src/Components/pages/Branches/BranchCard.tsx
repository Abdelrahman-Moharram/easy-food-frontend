...
import { IoLocationOutline, IoCallOutline, IoMailOutline, IoEllipsisHorizontal, IoSettingsOutline, IoTrashOutline, IoPencilOutline } from 'react-icons/io5';
...
const BranchCard: React.FC<BranchCardProps> = ({ branch, onEdit, onDelete, onSettings }) => {
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <div className="space-y-3 text-neutral-600 mb-6">
          <div className="flex items-start gap-3">
            <IoLocationOutline className="text-primary mt-1 flex-shrink-0" />
            <span className="text-sm line-clamp-2">{branch.address}</span>
          </div>
          <div className="flex items-center gap-3">
            <IoCallOutline className="text-primary flex-shrink-0" />
