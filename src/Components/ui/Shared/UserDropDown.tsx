...
const UserNavDropDown = ({ user }: Props) => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <MenuItems className="absolute -right-20 z-10 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-container shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          {/* <div className="py-1">
                <MenuItem>
                  {({ active }) => (
                    <Link
